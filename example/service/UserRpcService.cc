...
int main(int argc, char **argv)
{
    ...
    std::string serverIp = MpzrpcApplication::getApp().getConfig().getRpcServerIp();
    uint16_t serverPort = MpzrpcApplication::getApp().getConfig().getRpcServerPort();
